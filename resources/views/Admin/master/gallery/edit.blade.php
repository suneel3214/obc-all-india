...
<div class="container">
    ...
    <div class="row">
        <div class="col-xl-12 text-end">
            <a class="btn btn-primary" style="background-color:green!important;" href="{{ route('galleries.index') }}">Back</a>
        </div>
    </div>
    <div class="row mt-3" style="text-align: left;">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('galleries.update',$data->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
